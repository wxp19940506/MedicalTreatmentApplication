...
public class ScheduleXunJianCommonDescActivity extends BaseActivity {
    ...
    public void initData() {
        ...
        View headView = LayoutInflater.from(ScheduleXunJianCommonDescActivity.this).inflate(R.layout.common_desc_headview,null);
        ...
        enable.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectData.toString() != "{}"){
                    ...
                    intent.setClass(ScheduleXunJianCommonDescActivity.this,ScheduleNoteActivity.class);
                    if (id == 0){
                        setResult(Content.RESULT_CODE8,intent);
                    }else if (id == 1){
                        setResult(Content.RESULT_CODE9,intent);
                    }else if (id == 2){
                        setResult(Content.RESULT_CODE11,intent);
                    }else if (id == 3){
                        setResult(Content.RESULT_CODE12,intent);
                    }
                    finish();
                }else {
                    ToastUtils.showToastSafe(ScheduleXunJianCommonDescActivity.this,"请选择常用语");
            ...
            public void afterTextChanged(Editable s) {
                ...
                for (int i = 0; i < data.size(); i++) {
                    ...
                    if (datapinyin != null && searchWord != "" && searchWord.equals(datapinyin)  ){
                        ...
                        ToastUtils.showToastSafe(ScheduleXunJianCommonDescActivity.this,"没有要查询的数据");
                        BindOtherClassAdpterData(datasearch);
    ...
    class CommonDescAdapter extends BaseAdapter{
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (holder == null){
                ...
                convertView = LayoutInflater.from(ScheduleXunJianCommonDescActivity.this).inflate(R.layout.common_desc_itemview,parent,false);
        ...
        enable.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectData.toString() != "{}"){
                    ...
                    classData.setMap(selectData);
                    intent.putExtra("info",classData);
                    intent.setClass(ScheduleXunJianCommonDescActivity.this,ScheduleAddXunJianActivity.class);
                    if (id == 0){
                        setResult(Content.RESULT_CODE8,intent);
                    }else if (id == 1){
                        setResult(Content.RESULT_CODE9,intent);
