...
public class OfficeScheduleAdapter extends BaseAdapter implements View.OnClickListener {
    private List<OfficeScheduleInfo.ResultsBean.RowsBean> data;
    private Context context;
    int currentDepartmentID;
    int currentShiftTypeID;
    String currentDate,officeName,shiftName;



    public OfficeScheduleAdapter(Context context, List<OfficeScheduleInfo.ResultsBean.RowsBean> data, String officeName,String shiftName,int currentDepartmentID, int currentShiftTypeID,String currentDate) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        for (int i = 0; i <data.get(position).getCells().get(0).getItems().size(); i++) {
            Log.e("1",data.get(position).getCells().get(0).getItems().get(i).toString());
