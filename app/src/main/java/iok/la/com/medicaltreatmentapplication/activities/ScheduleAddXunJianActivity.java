...
public class ScheduleAddXunJianActivity extends BaseActivity {
    ...
    Observable observable,observableProblemDesx,observableImageDesx,observableImageUrl;
    Observer<ImageView> observer;
    Observer<TextView> observerImageUrl;
    ...
    public void initView() {
        proDialog = new Dialog(ScheduleAddXunJianActivity.this,R.style.progress_dialog);
        ...
        //问题
        itemView = LayoutInflater.from(ScheduleAddXunJianActivity.this).inflate(R.layout.problem_note_item, null);
        ...
        show_moreschedule.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectDepartments.toString().trim().equals("[]")){
                    ToastUtils.showToastSafe(ScheduleAddXunJianActivity.this,"请先选择巡检科室");
                }else {
        ...
        itemView.setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(ScheduleAddXunJianActivity.this);
        ...
        //图片
        addImagesItemView = LayoutInflater.from(ScheduleAddXunJianActivity.this).inflate(R.layout.add_images_contain, null);
        final ImageView selectimage1 = (ImageView) addImagesItemView.findViewById(R.id.selectimage);
        image_post = (RelativeLayout) addImagesItemView.findViewById(R.id.image_post);
        imagedesc = (EditText) addImagesItemView.findViewById(R.id.imagedesc);
        urlText = (TextView) addImagesItemView.findViewById(R.id.urlText);
            ...
            public void onClick(View v) {
                observable = Observable.create(new Observable.OnSubscribe<ImageView>() {
                    ...
                    public void call(Subscriber<? super ImageView> subscriber) {
                        subscriber.onNext(selectimage1);
                    }
                });
    ...
    public void initData() {
        String xunjianUrl = Content.BASE_URL + "AppRotas/PatrolsCreate?Token=" + PrefUtils.getString(getBaseContext(), "token", "");
        OkHttpUtils
                .get()
                .url(xunjianUrl)
                .build()
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        Gson gson = new Gson();
                        bean = gson.fromJson(response, XunjianBean.class);
                        ...
                        if (bean.isStatus()) {
                            ...
                            commondesc.setOnClickListener(new OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    List<XunjianBean.ItemsBean.SensBean> sentences = bean.getItems().getSens();
                                    ...
                                    Intent intent = new Intent(ScheduleAddXunJianActivity.this, ScheduleXunJianCommonDescActivity.class);
                            ...
                            final List<XunjianBean.ItemsBean.GesBean> ges = bean.getItems().getGes();
                            ...
                            for (int i = 0; i < bean.getItems().getPco().size(); i++) {
                                Map map = new HashMap();
                                map.put("name", bean.getItems().getPco().get(i).getName());
                                map.put("id", bean.getItems().getPco().get(i).getID());
                                map.put("pinyin", bean.getItems().getPco().get(i).getPinyin());
                                content0.add(map);
                            }
                            for (int i = 0; i < bean.getItems().getPct().size(); i++) {
                                Map map = new HashMap();
                                map.put("name", bean.getItems().getPct().get(i).getName());
                                map.put("id", bean.getItems().getPct().get(i).getID());
                                map.put("pinyin", bean.getItems().getPct().get(i).getPinyin());
                                content1.add(map);
                            }
                            //巡检科室数据
                            ...
                            int count0 = 0;
                            if (bean.getItems().getDps().size() >= 10) {
                                count0 = 10;
                                for (int i = 10; i < bean.getItems().getDps().size(); i++) {
                                    Map map = new HashMap();
                                    map.put("name", bean.getItems().getDps().get(i).getName());
                                    map.put("id", bean.getItems().getDps().get(i).getId());
                                    map.put("pinyin", bean.getItems().getDps().get(i).getPinyin());
                                    offices1.add(map);
                                }
                            } else {
                                count0 = bean.getItems().getDps().size();
                            }
                            ...
                            xunjian_cyperson.setOnClickListener(new OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    if (ymday.equals("")) {
                                        ToastUtils.showToastSafe(ScheduleAddXunJianActivity.this, "请选择巡检时间");
                                    } else {
                                        Intent intent = new Intent(ScheduleAddXunJianActivity.this,ScheduleXunJianPersonActivity.class);
                            ...
                            xunjian_office.setOnClickListener(new OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    //deparments.clear();
                                    Intent intent = new Intent(ScheduleAddXunJianActivity.this, XunJianOfficeActivity.class);
                                    OtherClassData classData = new OtherClassData();
                            ...
                            add_problems.setOnClickListener(new OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    final View itemView0 = LayoutInflater.from(ScheduleAddXunJianActivity.this).inflate(R.layout.problem_note_item, null);
                                    ImageView commondesc = (ImageView) itemView0.findViewById(R.id.commondesc);
                                    RelativeLayout show_moreschedule = (RelativeLayout) itemView0.findViewById(R.id.show_moreschedule);
                                    final TextView office_id = (TextView) itemView0.findViewById(R.id.office_id);
                                    final TextView office_name = (TextView) itemView0.findViewById(R.id.office_name);
                                    final EditText problem_desc = (EditText) itemView0.findViewById(R.id.problem_desc);
                                    commondesc.setOnClickListener(new OnClickListener() {
                                        @Override
                                        public void onClick(View v) {
                                            observableProblemDesx = Observable.create(new Observable.OnSubscribe<TextView>() {
                                                @Override
                                                public void call(Subscriber<? super TextView> subscriber) {
                                                    subscriber.onNext(problem_desc);
                                                }
                                    ...
                                    problem_contain.addView(itemView0);
                                    //问题记录长按删除
                                    itemView0.setOnLongClickListener(new OnLongClickListener() {
                                        @Override
                                        public boolean onLongClick(View v) {
                                            AlertDialog.Builder builder = new AlertDialog.Builder(ScheduleAddXunJianActivity.this);
                                            builder.setMessage("确定删除该数据？");
                                            ...
                                            builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                                @Override
                                                public void onClick(DialogInterface dialog, int which) {
                                                    problem_contain.removeView(itemView0);
                                                }
                                            });
                                            builder.setNegativeButton("取消", new DialogInterface.OnClickListener() {
                                                @Override
                            ...
                            image_show.setOnClickListener(new OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    final View addImagesItemView0 = LayoutInflater.from(ScheduleAddXunJianActivity.this).inflate(R.layout.add_images_contain, null);
                                    image_post = (RelativeLayout) addImagesItemView0.findViewById(R.id.image_post);
                                    final ImageView selectimage2 = (ImageView) addImagesItemView0.findViewById(R.id.selectimage);
                                    addimagedesc = (ImageView) addImagesItemView0.findViewById(R.id.addimagedesc);
                                    urlText = (TextView) addImagesItemView0.findViewById(R.id.urlText);
                                    final EditText imagedesc = (EditText) addImagesItemView0.findViewById(R.id.imagedesc);
                                    addimagedesc.setOnClickListener(new OnClickListener() {
                                        @Override
                                        public void onClick(View v) {
                                            observableImageDesx = Observable.create(new Observable.OnSubscribe<EditText>() {
                                    ...
                                    addImagesItemView0.setOnLongClickListener(new OnLongClickListener() {
                                        @Override
                                        public boolean onLongClick(View v) {
                                            AlertDialog.Builder builder = new AlertDialog.Builder(ScheduleAddXunJianActivity.this);
                                            builder.setMessage("确定删除该数据？");
                                            ...
                                            builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                                @Override
                                                public void onClick(DialogInterface dialog, int which) {
                                                    image_contain.removeView(addImagesItemView0);
                                                }
                                            });
                                            builder.setNegativeButton("取消", new DialogInterface.OnClickListener() {
                                                @Override
                                    ...
                                    image_contain.addView(addImagesItemView0);
                                }
                            });

                        } else {
                            ToastUtils.showToastSafe(ScheduleAddXunJianActivity.this, "参数错误");
                        }
...
//                Log.e("canshu","PatrolDate:"+date+"AreaID："+yuanquId+"Description:"+totlaDesc.toString()+"deparments:"+deparments.toString().toString()+"aSelectedEmployees:"+canyupersons.toString()+"schedules:"+schedules.toString());

                if (date.equals("")){
                    ToastUtils.showToastSafe(ScheduleAddXunJianActivity.this,"请选择巡检时间");
                }else if (yuanquId.equals("")){
                    ToastUtils.showToastSafe(ScheduleAddXunJianActivity.this,"请选择院区");
                }else if (canyupersons.toString().equals("[]")){
                    ToastUtils.showToastSafe(ScheduleAddXunJianActivity.this,"请选择巡检参与人");
                }else if (deparments.toString().equals("[]")){
                    ToastUtils.showToastSafe(ScheduleAddXunJianActivity.this,"请选择巡检科室");
                }else if (schedules.toString().equals("[]")){
                    ToastUtils.showToastSafe(ScheduleAddXunJianActivity.this,"请选择巡检内容");
                }else if (totlaDesc.equals("")){
                    ToastUtils.showToastSafe(ScheduleAddXunJianActivity.this,"请填写基本记录描述");
                }else if (!isEmipy){
                    ToastUtils.showToastSafe(ScheduleAddXunJianActivity.this, "问题科室或问题内容有一项为空");
                }else if (!isImageEmipy){
                    ToastUtils.showToastSafe(ScheduleAddXunJianActivity.this, "图片或描述有一项为空");
                }
                else {
                    OkHttpUtils
                            .post()
                            .url(Content.BASE_URL + "AppRotas/PatrolsCreate")
                                ...
                                public void onResponse(String response, int id) {
                                    try {
                                        ...
                                        if (jsonObject.optBoolean("status")){
                                            proDialog.dismiss();
                                            ToastUtils.showToastSafe(ScheduleAddXunJianActivity.this,"提交成功");
                                            finish();
                                        }else {
                                            ToastUtils.showToastSafe(ScheduleAddXunJianActivity.this,"提交失败");
                                            canyupersons.clear();
                                            deparments.clear();
                                            schedules.clear();
                                            departMentIds.clear();
    ...
    private void showPopWindowImage() {
        View fileView = LayoutInflater.from(ScheduleAddXunJianActivity.this).inflate(R.layout.filepop, null);
        ...
        View rootView = LayoutInflater.from(ScheduleAddXunJianActivity.this).inflate(R.layout.activity_schedule_add_xun_jian, null);
    ...
    //选择院区的pop数据
    private void initPopupWindow(final XunjianBean bean) {
        final List<Map<String, String>> list = new ArrayList<>();
        for (int i = 0; i < bean.getItems().getArea().size(); i++) {
            Map<String, String> map = new HashMap<>();
            map.put("name", bean.getItems().getArea().get(i).getName());
            map.put("id", String.valueOf(bean.getItems().getArea().get(i).getId()));
            list.add(map);
        }
        View view = LayoutInflater.from(ScheduleAddXunJianActivity.this).inflate(R.layout.office_list, null);
        ListView officelist = (ListView) view.findViewById(R.id.officelist);
        SimpleAdapter adapter = new SimpleAdapter(ScheduleAddXunJianActivity.this, list, R.layout.office_item, new String[]{"name"}, new int[]{R.id.office_item});
...
//            showProblemContent(data, problem_content);
    ...
    private void getImageFronUri(final Intent data) {
        ...
        observer = new Observer<ImageView>() {
            ...
            @Override
            public void onNext(ImageView imageView) {
                Picasso.with(ScheduleAddXunJianActivity.this).load(data.getData()).error(R.mipmap.wei).placeholder(R.mipmap.wei).into(imageView);
            }
        };
        if (observable != null & observer != null)
            observable.subscribe(observer);
        final String imagePath = getPathByUri4kitkat(ScheduleAddXunJianActivity.this, data.getData());
...
//        imageFiles.put(PrefUtils.getString(getBaseContext(), "username", "") + System.currentTimeMillis() + name, file);
    }
    ...
    private void showProblemContent(Intent data, EditText desc_info) {
        ...
        Log.e("databuffer",databuffer.toString());
    ...
    class ImagesDescPostAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            View view = LayoutInflater.from(ScheduleAddXunJianActivity.this).inflate(R.layout.imagelist, parent, false);
            return view;
        }
    }
    ...
    private void initSchedulePopupWindow(final TextView text, final TextView idText, final List<Map<String, String>> aselectDepartments) {
        View view = LayoutInflater.from(ScheduleAddXunJianActivity.this).inflate(R.layout.office_list, null);
        ListView officelist = (ListView) view.findViewById(R.id.officelist);
        SimpleAdapter adapter = new SimpleAdapter(ScheduleAddXunJianActivity.this, aselectDepartments, R.layout.office_item, new String[]{"name"}, new int[]{R.id.office_item});
        officelist.setAdapter(adapter);
