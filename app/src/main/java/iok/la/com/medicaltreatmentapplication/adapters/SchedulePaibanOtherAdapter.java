...
import iok.la.com.medicaltreatmentapplication.activities.SchedulePaibanOtherActivity;
...
public class SchedulePaibanOtherAdapter extends BaseAdapter implements View.OnClickListener {
    private List<SchedulePaiBanOtherBean.ResultsBean.DtBean.RowsBean> data;
    private Context context;
    public SchedulePaibanOtherAdapter(Context context,List<SchedulePaiBanOtherBean.ResultsBean.DtBean.RowsBean> data) {
