...
public class ScheduleZhuangTaiEditAdapter extends BaseAdapter {
    List<ScheduleNoteEditData.ResultsBean.RotaStatusBean>  rotaCategories;
    Context context;
    List data = new ArrayList();
    int[] zhuangtaiIcons;
    List<CheckBox> boxs = new ArrayList<>();
    public ScheduleZhuangTaiEditAdapter(Context context, List<ScheduleNoteEditData.ResultsBean.RotaStatusBean> rotaCategories, int[] zhuangtaiIcons) {
