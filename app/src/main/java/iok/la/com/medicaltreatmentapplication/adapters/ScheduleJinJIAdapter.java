...
public class ScheduleJinJIAdapter extends BaseAdapter {
    List<ScheduleNoteAddData.ResultsBean.RotaImportancesBean> rotaCategories;
    Context context;
    List<CheckBox> boxs = new ArrayList<>();
    int[] jinjiIcons;
    public ScheduleJinJIAdapter(Context context, List<ScheduleNoteAddData.ResultsBean.RotaImportancesBean> rotaCategories, int[] jinjiIcons) {
