...
public class ScheduleJieBanZhuangTaiAdapter extends BaseAdapter {
    Context context;
    List<SceduleJiaoBanAddNoteData.ResultsBean.StasBean> rotaCategories;
    List data = new ArrayList();
    int[] zhuangtaiIcons;
    List<CheckBox> boxs = new ArrayList<>();
    public ScheduleJieBanZhuangTaiAdapter(Context context, List<SceduleJiaoBanAddNoteData.ResultsBean.StasBean> rotaCategories, int[] zhuangtaiIcons) {
